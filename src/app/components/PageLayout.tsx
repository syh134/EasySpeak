  ...
  return (
    <div className="flex min-h-screen bg-gray-50">
      <aside className="w-64 shrink-0 h-screen sticky top-0 p-4">
        <div className="h-full bg-white rounded-3xl border border-gray-100 shadow-lg shadow-gray-200/50 flex flex-col">
          <div className="p-6 border-b border-gray-100">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-gray-400 text-xs">Discussion Platform</p>
              </div>
            </div>
          </div>
          ...
          <nav className="flex-1 px-4 py-6 space-y-2">
            ...
            {navItems.map((item) => (
              ...
              >
                <div className={`p-2 rounded-xl transition-all ${activeTab === item.id ? 'bg-white/20' : 'bg-gray-100'}`}>
          ...
          <div className="p-4 border-t border-gray-100">
            <button
              ...
              className="w-full bg-gradient-to-r from-blue-500 to-indigo-600 text-white py-3.5 rounded-2xl font-semibold text-sm shadow-lg shadow-blue-500/25 hover:shadow-xl hover:shadow-blue-500/30 transition-all"
            >
              + New Topic
            </button>
          </div>
