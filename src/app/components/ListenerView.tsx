      ...
      <div className="space-y-5">
        <div className="backdrop-blur-3xl bg-white/20 rounded-2xl border border-white/30 shadow-xl shadow-black/5 p-5">
          <div className="flex items-center justify-between mb-4">
            <div className="flex items-center gap-2">
              ...
              <p className="text-xs font-semibold text-gray-500 uppercase tracking-widest">Live Discussion</p>
            </div>
            <div className="flex items-center gap-4 text-sm">
              <span className="text-emerald-500 font-semibold">+{votes.agree}</span>
              <span className="text-gray-300">|</span>
              <span className="text-rose-500 font-semibold">+{votes.disagree}</span>
            </div>
          </div>
          <div className="h-2.5 bg-gray-200/30 rounded-full overflow-hidden backdrop-blur-xl">
            <div
        ...
        <div>
          ...
          <div className="space-y-3">
            {previousViewpoints.map((point, index) => (
              <div
                key={index}
                className="backdrop-blur-3xl bg-white/20 rounded-xl border border-white/30 p-4 hover:bg-white/30 transition-all"
              >
                <div className="flex items-start gap-3">
                  <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-violet-500 to-fuchsia-500 p-0.5 shrink-0">
        ...
        <div className="backdrop-blur-3xl bg-white/20 rounded-2xl border border-white/30 shadow-xl shadow-black/5 p-6">
          <div className="text-center mb-5">
            <div className="inline-flex items-center gap-2 bg-emerald-500/20 border border-emerald-500/30 text-emerald-600 px-3 py-1.5 rounded-full text-xs font-semibold mb-3">
          ...
          <div className="backdrop-blur-xl bg-gradient-to-r from-violet-500/90 via-fuchsia-500/90 to-pink-500/90 rounded-xl p-5 mb-5 border border-white/20">
          ...
          <div className="flex gap-3 mb-4">
            {userVoted ? (
              <>
                <button className="flex-1 py-3 rounded-xl font-medium text-sm bg-emerald-500/20 text-emerald-600 border border-emerald-500/30 cursor-not-allowed">
                  Agreed
                </button>
                <button className="flex-1 py-3 rounded-xl font-medium text-sm bg-rose-500/20 text-rose-600 border border-rose-500/30 cursor-not-allowed">
                  Disagreed
                </button>
              </>
            ) : (
              <>
                <button
                  ...
                  className="flex-1 py-3 rounded-xl font-medium text-sm backdrop-blur-xl bg-white/50 text-gray-700 border border-white/30 hover:border-emerald-400 hover:text-emerald-600 hover:bg-emerald-500/10 transition-all"
                >
                  Agree
                </button>
                <button
                  onClick={() => { setVotes(v => ({ ...v, disagree: v.disagree + 1 })); setUserVoted(true); }}
                  className="flex-1 py-3 rounded-xl font-medium text-sm backdrop-blur-xl bg-white/50 text-gray-700 border border-white/30 hover:border-rose-400 hover:text-rose-600 hover:bg-rose-500/10 transition-all"
                >
                  Disagree
                </button>
              </>
